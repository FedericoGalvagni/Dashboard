...
import 'package:interface_example1/pages/panoramica/widgets/info_card.dart';
...
class PanoramicaCardsSmall extends StatelessWidget {
  const PanoramicaCardsSmall({Key? key}) : super(key: key);
