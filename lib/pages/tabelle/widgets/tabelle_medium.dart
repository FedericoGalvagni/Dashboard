...
class TabelleMedium extends StatefulWidget {
  /// Limite numero righe richieste
  String limit;

  /// Identificativo richiesta http
  String? id;
  TabelleMedium({Key? key, this.limit = "100", this.id}) : super(key: key);

  @override
  TabelleMediumState createState() => TabelleMediumState();
}

class TabelleMediumState extends State<TabelleMedium> {
