...
class TabelleLarge extends StatefulWidget {
  /// Limite numero righe richieste
  String limit;

  /// Identificativo richiesta http
  String? id;
  TabelleLarge({Key? key, this.limit = "100", this.id}) : super(key: key);

  @override
  TabelleLargeState createState() => TabelleLargeState();
}

class TabelleLargeState extends State<TabelleLarge> {
